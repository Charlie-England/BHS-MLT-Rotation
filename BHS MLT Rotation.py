...
def run_list_randomizer():
    ...
    day = 1
    count = 1
    rev_len = int(len(providers)*(.5)) #reverse length, the amount of days before a provider can be selected again. Based on 1/2 the number of providers, 6 providers = 3 days
    move_fwrd_day = False
